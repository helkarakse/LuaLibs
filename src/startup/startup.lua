...
local fileArray = {
	{link = "https://bitbucket.org/helkarakse/lualibs/raw/master/src/functions.lua", file = "functions"},
	{link = "https://bitbucket.org/helkarakse/lualibs/raw/master/src/xml.lua", file = "xml"},
	{link = "https://bitbucket.org/helkarakse/rssdisplay/raw/master/src/main.lua", file = "main"}
}
